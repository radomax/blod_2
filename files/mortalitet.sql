...
CREATE TABLE `contact_requests` (
  ...
  `subject` enum('question','correction','tech','other') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `icd_codes` (
  ...
  `parent_code` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `icd_chapter` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `record_revisions` (
  ...
  `record_id` int NOT NULL,
  `revision_type` enum('create','update','delete') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `system_logs` (
  `log_id` int NOT NULL,
  `log_type` enum('info','warning','error','security') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `log_message` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `log_source` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
ALTER TABLE `death_causes`
  MODIFY `cause_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
